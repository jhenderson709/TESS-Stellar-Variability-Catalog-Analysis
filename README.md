...
Though beyond the scope of this project, the ultimate function of pulsations ought to be mentioned: Physical parameters of a star like surface temperature, gravity, mass, luminosity, etc, experience some degree of instability – instability that, in the case of variable stars, is related to pulsation period. Each pulsation period is associated with n, l, m geometry (spherical harmonics), therefore, we can use n, l, m geometry to constrain free parameters. Thus, as we work out the parameters of pulsation geometry for each pulsation mode detected, we are narrowing the pool of possible solutions for the stellar structure of a given star. Crucially, there is only one true solution for the stellar structure for a given object, and this work hopes to bring us closer to that solution for the stars discussed. 
